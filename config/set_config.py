...
class Config(object):
    def __init__(self):
        # 配置数据路径
        self.base_path = r"D:\工作\py_program\chess_logic"
        self.data_warehouse = os.path.join(self.base_path,'datawarehouse')
        self.ref = os.path.join(self.base_path, 'chess_library')
